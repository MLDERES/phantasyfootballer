# phantasyfootballer documentation build
...
htmlhelp_basename = "phantasyfootballerdoc"
...
man_pages = [
    (master_doc, "phantasyfootballer", "phantasyfootballer Documentation", [author], 1,)
]
...
texinfo_documents = [
    (
        ...
        author,
        "phantasyfootballer",
        "Project phantasyfootballer codebase.",
        "Data-Science",
    )
]
